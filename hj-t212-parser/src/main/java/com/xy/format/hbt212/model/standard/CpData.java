...
public class CpData {
    ...
    @ValidDate(format = "yyyyMMddHHmmssSSS", groups = Group.Version.V2005.class)
    @JsonProperty("QN")
    @JsonbProperty("QN")
    private String qn;
    ...
    @Min(value = 30, groups = Group.Version.V2017.class)
    @Max(value = 3600, groups = Group.Version.V2017.class)
    @JsonProperty("RtdInterval")
    @JsonbProperty("RtdInterval")
    private Integer rtdInterval;

    @Max(value = 99, groups = Group.Version.V2017.class)
    @JsonProperty("MinInterval")
    @JsonbProperty("MinInterval")
    private Integer minInterval;

    @ValidDate(format = "yyyyMMddHHmmss", groups = Group.Version.V2017.class)
    @JsonProperty("RestartTime")
    @JsonbProperty("RestartTime")
    private String restartTime;

    @ValidDate(format = "yyyyMMddHHmmss", groups = Group.Version.V2005.class)
    @JsonbProperty("AlarmTime")
    @JsonProperty("AlarmTime")
    private String alarmTime;

    @N(integer = 1, min = 0, max = 1, groups = Group.Version.V2005.class)
    @JsonbProperty("AlarmType")
    @JsonProperty("AlarmType")
    private String alarmType;

    @N(integer = 20, groups = Group.Version.V2005.class)
    ...
    @N(integer = 4, groups = Group.Version.V2005.class)
    @JsonProperty("ReportTime")
    @JsonbProperty("ReportTime")
    private String reportTime;

    @N(integer = 14, groups = Group.Version.V2005.class)
    ...
    @C(len = 6, groups = Group.Version.V2017.class)
    @JsonProperty("NewPW")
    @JsonbProperty("NewPW")
    private String newPW;

    @Max(value = 99999, groups = Group.Version.V2005.class)
    @Max(value = 99, groups = Group.Version.V2017.class)
    ...
    @Max(value = 99, groups = Group.Version.V2005.class)
    @Min(value = 0, groups = Group.Version.V2017.class)
    @Max(value = 24, groups = Group.Version.V2017.class)
    @JsonProperty("CTime")
    @JsonbProperty("CTime")
    ...
    @ValidDate(format = "HHmmss", groups = Group.Version.V2017.class)
    @JsonProperty("CstartTime")
    @JsonbProperty("CstartTime")
    private String cStartTime;

    @Min(value = 0, groups = Group.Version.V2017.class)
    @Max(value = 120, groups = Group.Version.V2017.class)
    @JsonProperty("Stime")
    @JsonbProperty("Stime")
